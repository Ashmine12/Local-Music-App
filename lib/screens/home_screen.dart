...
import 'package:local_music_app/helper/audio_player_helper.dart';
import 'package:local_music_app/helper/offline_audio_query.dart';
import 'package:local_music_app/ui_utils/ui_utils.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> initialTasks() async {
    ...
    if (permissionStatus) {
      ...
      debugPrint(
          " Home screen song List Length = ${HomeScreen.songsList.length}");
    }
    setState(() {
      loading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.purpleAccent,
        title: const Text("Local Music App"),
        centerTitle: true,
      ),
      body: loading
          ? const Center(
